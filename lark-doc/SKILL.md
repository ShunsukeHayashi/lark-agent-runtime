...
| [`+mention-link`](references/lark-doc-mention-link.md) | **被リンク作成**：text_run URL を mention_doc に変換してLark相関図に認識させる。lark-cliのmarkdown変換は常にtext_runを生成するため、被リンクを作るには必ずこの方法を使う。 |
