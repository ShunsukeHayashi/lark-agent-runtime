...
| `your-tenant.jp.larksuite.com` ドメインのURL（text_run） | `text_run` | **されない** |
...
例：https://your-tenant.jp.larksuite.com/docx/REPLACE_WITH_DOC_TOKEN
```
...
# 例
patch_mention(
    doc_id="REPLACE_WITH_SOURCE_DOC_ID",
    block_id="REPLACE_WITH_BLOCK_ID",
    token="REPLACE_WITH_TARGET_DOC_TOKEN",
    title="サンプル被リンク先タイトル"
)
```
